...
public class TestGame {
     ...
     * initGameWithInput(String simulatedInput): Initialize the game with a buffer
     * already set with the input.
    ...
    public void testGetPlayersAlive() throws NegativeLifeValueException, BadNumberOfPlayersException {
        ...
        // Set the life of one player to 0 to see if the number of player alive is the
        // right one
    ...
    public void testCreatePlayer() {
        ...
        // PlayerWithANameTooLong is invalid because it raised
        // PlayerNameTooLongException
        // Player1 is invalid because a player already has this name
        // Player5 is a valid name because no one has the name and itas not raising any
        // exception
    ...
    public void testPlayOnePlayer() throws NotEnoughCardsInDeckException, TooManyCardsException, RemovingTooManyCards {
        ...
        // sure they can play at least a card
